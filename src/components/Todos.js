...
const Todos = () => {
  const getInitialTodos = () => JSON.parse(window.localStorage.getItem("my-todos-list")) || initialTodos;
  ...
  return (
    <main>
      ...
      <h3 className="text-end-5 mb-5 text-success">
      ...
      <TodosList todos={filteredTodos} deleteTodo={deleteTodo} toggleCompleteTodo={toggleCompleteTodo} />
